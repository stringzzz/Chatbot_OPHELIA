...
chatlog = []
Xchatlog = []
chatlogFile = {"regular": "/home/stringzzz/aChatbotOPHELIA/DoubleChat/Doublechatlog.txt", "extended": "/home/stringzzz/aChatbotOPHELIA/DoubleChat/DoubleXchatlog.txt" }
...
tempValues = []
emotion_dictionary_file = open("/home/stringzzz/aChatbotOPHELIA/DoubleChat/emotionDictionary.txt", 'r')
...
gotPair = 0
tempValues = []
message_dictionary_file = open("/home/stringzzz/aChatbotOPHELIA/DoubleChat/messageDictionary.txt", 'r')
for emotion in nEmotions:
...
tempValues = []
emotion_dictionary_file = open("/home/stringzzz/aChatbotOPHELIA/DoubleChat/emotionDictionary_Phoebe.txt", 'r')
for line in emotion_dictionary_file.readlines():
	if line == "":
		break
	tempValues = (line.strip()).split(' ')
...
gotPair = 0
tempValues = []
message_dictionary_file = open("/home/stringzzz/aChatbotOPHELIA/DoubleChat/messageDictionary_Phoebe.txt", 'r')
for emotion in nEmotions:
	messagesNo = int(message_dictionary_file.readline())
	for messages in range(0, messagesNo):
		if gotPair < 2:
...
try: 
	user_file = open("/home/stringzzz/aChatbotOPHELIA/DoubleChat/Phoebe.txt", 'r')
	for emotion in nEmotions:
...
#Input the user file for the current user, if it exists
try: 
	user_file = open("/home/stringzzz/aChatbotOPHELIA/DoubleChat/OPHELIA.txt", 'r')
	for emotion in nEmotions:
...
botReply("hello, Phoebe")
userMessage_Phoebe = "hello"
...
while chatCount <= 30:
	...
	while(True):
		...
		try:
			...
			userMessage = PhoebePreviousResponse
			break
		except(KeyError):
	...
	while(True):
		...
		try:
			...
			userMessage_Phoebe = OPHELIAPreviousResponse
			break
		except(KeyError):
			pass #Exact match not found in message dictionary
...
emotion_dictionary_file = open("/home/stringzzz/aChatbotOPHELIA/DoubleChat/emotionDictionary.txt", 'w')
...
message_dictionary_file = open("/home/stringzzz/aChatbotOPHELIA/DoubleChat/messageDictionary.txt", 'w')
for emotion in nEmotions:
...
data_file = open("/home/stringzzz/aChatbotOPHELIA/DoubleChat/OPHELIAdata.txt", 'w')
data_file.write("Words in emotion dictionary: " + str(len(emotionDictionary)) + "\n")
for emotion in nEmotions:
...
user_file = open("/home/stringzzz/aChatbotOPHELIA/DoubleChat/Phoebe.txt", 'w')
for emotion in nEmotions:
	user_file.write(str(user_emotions[emotion]) + "\n")
user_overall_mood = getMood(user_emotions)
user_file.write("Phoebe seems to be a(n) " + user_overall_mood + " person.")
user_file.close()

dictionaryCounts = { "neutral": 0, "happy": 0, "angry": 0, "sad": 0, "afraid": 0 }
nEmotions2 = ["neutral", "happy", "angry", "sad", "afraid"]
emotion_dictionary_file = open("/home/stringzzz/aChatbotOPHELIA/DoubleChat/emotionDictionary_Phoebe.txt", 'w')
...
message_dictionary_file = open("/home/stringzzz/aChatbotOPHELIA/DoubleChat/messageDictionary_Phoebe.txt", 'w')
for emotion in nEmotions:
...
data_file = open("/home/stringzzz/aChatbotOPHELIA/DoubleChat/Phoebedata.txt", 'w')
data_file.write("Words in emotion dictionary: " + str(len(emotionDictionary_Phoebe)) + "\n")
for emotion in nEmotions:
...
user_file = open("/home/stringzzz/aChatbotOPHELIA/DoubleChat/OPHELIA.txt", 'w')
for emotion in nEmotions:
	user_file.write(str(user_emotions_Phoebe[emotion]) + "\n")
user_overall_mood = getMood(user_emotions_Phoebe)
user_file.write("OPHELIA seems to be a(n) " + user_overall_mood + " person.")
user_file.close()
